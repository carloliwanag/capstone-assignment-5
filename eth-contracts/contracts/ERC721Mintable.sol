...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Address should be valid");
        require(newOwner != _owner, "You're passing to yourself");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    function pause(bool pausedStatus) public onlyOwner {
        require(pausedStatus != _paused, "Setting the same state");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "Address owns the token");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            owner == msg.sender || isApprovedForAll(owner, msg.sender),
            "Token does not belong to the sender or not allowed"
        );
    ...
    function _transferFrom(
        ...
        require(ownerOf(tokenId) == from, "Token is not owned by the address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        ...
        _tokenURIs[tokenId] = concatTokenURI;
    }
}
